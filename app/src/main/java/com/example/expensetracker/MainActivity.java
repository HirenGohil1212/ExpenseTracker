...
public class MainActivity extends AppCompatActivity implements OnItemsClick {
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for(DocumentSnapshot ds:dsList){
                            ExpenseManager expenseManager = ds.toObject(ExpenseManager.class);
                            if(expenseManager.getType().equals("Income")){
                                income+=expenseManager.getAmount();

                            }else{
                                expense+=expenseManager.getAmount();
                            }
                            expenseAdapter.add(expenseManager);
                        }
                        setUpGraph();
                    }
                });
    ...
    private void setUpGraph() {
        ...
        binding.pieChart.setData(pidata);
    ...
    @Override
    public void onClick(ExpenseManager expenseManager) {
        intent.putExtra("model",expenseManager);
        startActivity(intent);
